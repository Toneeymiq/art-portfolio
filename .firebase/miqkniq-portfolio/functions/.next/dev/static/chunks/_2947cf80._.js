...
function AdminPosts() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminPosts.useEffect": ()=>{
            const unsub = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'posts'), {
                "AdminPosts.useEffect.unsub": (snap)=>{
                    const data = snap.docs.map({
                        "AdminPosts.useEffect.unsub.data": (doc)=>({
                                id: doc.id,
                                ...doc.data(),
                                createdAt: doc.data().createdAt?.toDate?.() || new Date(),
                                updatedAt: doc.data().updatedAt?.toDate?.() || new Date()
                            })
                    }["AdminPosts.useEffect.unsub.data"]);
                    data.sort({
                        "AdminPosts.useEffect.unsub": (a, b)=>new Date(b.publishDate).getTime() - new Date(a.publishDate).getTime()
                    }["AdminPosts.useEffect.unsub"]);
                    setPosts(data);
                    setLoading(false);
                }
            }["AdminPosts.useEffect.unsub"]);
            ...
            async function fetchArtworks() {
                ...
                const arts = snap.docs.map({
                    "AdminPosts.useEffect.fetchArtworks.arts": (d)=>({
                            id: d.id,
                            ...d.data()
                        })
                }["AdminPosts.useEffect.fetchArtworks.arts"]);
                setArtworks(arts);
            }
            fetchArtworks();
            return ({
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    post.status === 'draft' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(AdminPosts, "JMlv/E+bMjzu7uLeahUqWt/yfYk=");
_c = AdminPosts;
var _c;
...
//# sourceMappingURL=_2947cf80._.js.map
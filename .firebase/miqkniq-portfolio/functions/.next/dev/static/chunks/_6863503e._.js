...
function AdminDashboard() {
    ...
    const { allComments, fetchAllComments, allCommentsLoading, deleteComment: deleteCommentFromContext } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$CommentsContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCommentsContext"])();
    ...
    const handleDeleteComment = async (commentId, targetId)=>{
        if (confirm('Are you sure you want to delete this comment?')) {
            ...
            fetchAllComments(); // Refresh the list
        }
    };
    // Calculate stats
...
_s(AdminDashboard, "gXRGlm1NV0TLn7P6T8z1MmibyeA=", false, function() {
    return [
...
//# sourceMappingURL=_6863503e._.js.map